...
from backend.src.config import DEFILLAMA_PROTOCOLS_URL, DEFILLAMA_FEES_OVERVIEW_URL, DEFILLAMA_REVENUE_OVERVIEW_URL, COINMARKETCAP_LISTINGS_LATEST_URL, COINMARKETCAP_API_KEY
